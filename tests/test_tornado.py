...
import nomad_alt.tornado
import common

Check = nomad_alt.Check
...
# class TestNomad(object):
    # def test_kv(self, loop, nomad_port):
    #     @gen.coroutine
    #     def main():
    #         c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_kv_binary(self, loop, nomad_port):
    #     @gen.coroutine
    #     def main():
    #         c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_kv_missing(self, loop, nomad_port):
    #     c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_kv_put_flags(self, loop, nomad_port):
    #     @gen.coroutine
    #     def main():
    #         c = nomad_alt.tornado.Nomad(port=nomad_port)
    #         yield c.kv.put('foo', 'bar')
    ...
    # def test_kv_delete(self, loop, nomad_port):
    #     @gen.coroutine
    #     def main():
    #         c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_kv_subscribe(self, loop, nomad_port):
    #     c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_kv_encoding(self, loop, nomad_port):
    #     @gen.coroutine
    #     def main():
    #         c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_transaction(self, loop, nomad_port):
    #     @gen.coroutine
    #     def main():
    #         c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_agent_services(self, loop, nomad_port):
    #     @gen.coroutine
    #     def main():
    #         c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_catalog(self, loop, nomad_port):
    #     c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_health_service(self, loop, nomad_port):
    #     @gen.coroutine
    #     def main():
    #         c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_health_service_subscribe(self, loop, nomad_port):
    #     c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    # def test_session(self, loop, nomad_port):
    #     c = nomad_alt.tornado.Nomad(port=nomad_port)
    ...
    #
    # def test_connectivity(self, loop, acl_nomad):
    #     @gen.coroutine
    #     def main():
    #         # print("Connect to port %s" % acl_nomad.port)
    #         # c = nomad_alt.tornado.Nomad(port=acl_nomad.port)
    #         c = nomad_alt.tornado.Nomad(port=common.NOMAD_PORT)
    #
    #         # job_list = yield c.jobs.list()
    ...
    # def test_acl(self, loop, acl_nomad):
    #     @gen.coroutine
    #     def main():
    #         c = nomad_alt.tornado.Nomad(
    #             port=acl_nomad.port, token=acl_nomad.token)
            ...
            # except nomad_alt.exceptions.ACLPermissionDenied:
            #     raised = True
            # assert raised
